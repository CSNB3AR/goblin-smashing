...
This is the mechanic Tatsuya's goblin lock interacts with, not subverts (see Writing Bible §7, "The goblin glitch, mechanism," for the full scene-level detail): he was mid-selection, browsing race options on an overridden first-gen pod, when the arcade's power blipped and the pod rebooted mid-choice, locking in whatever he'd paused on, goblin, the weakest race in the game, by hardware accident. **That lock is a separate, unrelated system from the rare-variant roll.** The roll still ran for him at the moment of creation, same as it does for every character, no exceptions, and his came back rare: **Gambler's Gambit** (see §4 below for the necklace's own, distinct ability, which is not the same thing). Not being able to reset the character afterward and getting a rare variant at the moment of creation are unrelated systems, one about undoing a character later, one about a bonus at the exact moment it's made. The irony is the one piece of luck the system handed him landed on the one race everybody else throws away.
...
### Drive color
An HGO access drive is a neutral silver/clear color before a character is created on it. Once a race is chosen (or, in Tatsuya's case, locked in by the power-blip accident), the physical drive changes color to match, a standard goblin roll comes out a dull, ordinary green, the color most players and NPCs recognize a goblin by at a glance. Tatsuya's drive skips straight past that ordinary green: because his rare-variant roll hit (Gambler's Gambit), his drive reads a distinct **emerald green** from the moment of creation, visibly different from an ordinary goblin's drive even before the Call of the Bones Necklace (see §4) bonds him to Shiv later and deepens that same bond further.
...
Shiv's Warset stays a 7-piece legendary set (see `bible/old-draft-chapter-bible.md`); the necklace remains piece 1 of 7.

**Two separate Fortune/gambling-themed abilities exist, not one, and they must not be conflated:**
...
Full roster with per-team/per-guild identity now lives in `codex/lore/tournament-ecosystem-and-guilds.md`, single source of truth, don't duplicate the list here. Includes Kansai Black Lotus and London Spire (both already on the page) plus the rest of the regional pro scene, and the guild roster including Arya's own guild, Crimson Static.
