...
- **Inner monologue in italics, no quotation marks**, dropped directly into the narration mid-paragraph rather than set off as its own beat every time. Already a Writing Bible rule; the sample is a useful model for how naturally it can sit inside a sentence instead of interrupting it.
