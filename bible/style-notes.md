...
- **Inner monologue in quotation marks, not italics** (house format, see Writing Bible §10, changed from an earlier italics-only pass, quotation marks are now the standing rule), dropped directly into the narration mid-paragraph rather than set off as its own beat every time. The sample is still a useful model for how naturally it can sit inside a sentence instead of interrupting it, just apply that lesson with quotation marks now.
