...
- **Do not** introduce Yuna by name in Chapter 1 — she's a voice on the broadcast that Tatsuya registers without fully engaging. Her name and identity land later, at the hospital.
...
- **World Quests:** global quest lines any player can attempt. Completion can generate a "world-level item," extremely rare, powerful, globally significant gear that still matters (in nerfed form) even in ranked esports play. Only one major world quest has occurred since launch so far.
