...
**Player death penalty.** On death, a player has a chance to drop one item from their inventory, not the whole inventory, and the odds skew toward their better/rare items specifically rather than junk. Real, meaningful stakes tied to the seven-day death lock (see `codex/lore/preserved-misc-mechanics.md`), not just a respawn timer.
