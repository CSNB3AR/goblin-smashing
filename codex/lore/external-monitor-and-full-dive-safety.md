...
## The real fix, Chapter 8-9: parts, urgency, and the Tochi lead

The ten-to-fifteen-minute Chapter 8 shutdown gets the override stabilized, not a permanent repair, Leon's rig is still degrading under the combined monitoring/streaming load. In the following real-world stretch, Tatsuya gets an email lead with real, specific part numbers, the actual components that bridge first-gen monitor hardware with something closer to third-gen reliability. He doesn't have the technical knowledge to act on it himself yet, a real, felt gap, not a minor inconvenience, and it's what pushes him to seriously consider Tochi Academy's tech program (see `codex/subplots/tochi-academy-return.md`) as the realistic way to actually learn this, faster and cheaper than a university path he doesn't have the time or money for. Ties this file's overheating thread directly into the open Tochi decision rather than leaving them as two separate pressures.
