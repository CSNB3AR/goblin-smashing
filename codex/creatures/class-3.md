...
Dangerous, typically requires a party or a genuinely skilled/overleveled solo player, named regional threats rather than ambient wildlife. See `codex/creatures/overview.md` for the stat-block convention and the four-class system generally.
...
Identity: the dominant figure of an insectoid hive-cluster, found in deep cave systems, commands lesser hive-members the way the Frostmaw Direwolf commands wolves.

- **Stats:** Power very high, Speed moderate, Wisdom moderate (real tactical coordination of its hive).
- **Abilities:** Innate — commands nearby hive-members in combat. Activated — Carapace Slam, a heavy melee strike, and Chitter Call, summons additional hive-members to the fight (not a magical summon, a call to already-present nearby creatures, consistent with the "no summoning magic, ever" rule, see `codex/lore/crafting-and-alchemy.md`).
- **Rarity:** Rare.
