...
Suit jacket over a ratty soccer jersey, glasses down his nose, cigarette stubs.

## Facts

- Has two first-gen Kazuhaya Tech pods, but only one is actually functional, the sole first-gen pod still running in the area. The other is a dead shell, unrepaired, a plausible future beat for Tatsuya's growing technical role at the arcade (see `codex/subplots/technical-arc-leon-and-sakura-arcade.md`).
...
- **The coach role, real start Chapter 9.** Leon starts sitting in over voice chat during real fights, not just running the operator booth, the "Coach... yeah, I could see that" beat from Chapter 8 paying off directly. When Tatsuya can't stop mid-dive to research something himself, Leon looks it up in real time and feeds it back to him, wiki threads, forum speculation, whatever's actually findable. Not always accurate, secondhand research off public sources, not official documentation, a real, occasionally-wrong information feed rather than an infallible one.
