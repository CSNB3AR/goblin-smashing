...
See `codex/objects/haya-eb.md` for his scooter, and `codex/objects/hgo-access-drive.md` for his HGO drive.
...
- `codex/subplots/yuna-tatsuya-slow-burn-romance.md` — seeded gradually, not front-loaded.
