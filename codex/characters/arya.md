...
**The collapse, full sequence (surfaces Chapter 9).** Crimson Static qualified for the Winter Championship as a three-leader guild (Arya plus two others), then went winless in group play entirely, best-of-three King of the Hill, not a single map taken. The loss came down to infighting, not outplay, Arya was the only one of the three who actually played it like competition (best kill/point ratio on the team by a wide margin), the other two were chasing viewership and stream moments over the actual matches. As guild leader, Arya kicked both of them afterward for it, a call she stands by. In retaliation, the two started a rumor campaign against her, exaggerated, dishonest, and it worked: the guild bled from 80-90+ members down to roughly three who actually knew what happened and stayed. Arya rebuilt under a new guild name with a couple of new recruits, one of them an auction-house specialist she leans on for gear logistics. She's currently sitting on a fresh, low-level mage build (level 10-11), most of her discipline points still unspent, deliberately held back since the collapse rather than sunk into a build she can't yet commit to.
