...
- Gambler's Gambit procs, legacy-tier rare gear drops unbound: Ironhide Chestplate, Vanguard's Greaves, PK Raiding Crest.
- Viewer count climbs live, **[VIEWERS: 940 → 3,610]**, Arya's assist credited on-stream, her own disbelief that her name is in the kill feed at all.
- Named chat exchange, exactly three handles speak: **Taja_11** (Taji, quiet almost-recognition, doesn't call it out directly), **Pac_Pac** (new local-rapper character, reacts to the spectacle itself), **AriSky** (Arya's own confirmed Loop/stream handle). Tatsuya replies once, deliberately gives nothing away and doesn't ignore it either.
- PK_Wraith reacts live in chat, a real threat line, not background noise: **[@PK_Wraith: whoever's running that goblin account just made themselves a permanent problem]**. Arya explains the practical fallout (informal blacklist through any guild that answers to him) and offers her own guild's auction-house contact to move the loot safely.
- Chapter ends on the two of them walking back up the hill with Ru, the road "finally, quietly, theirs again," then **[END CHAPTER EIGHT]**.
