...
- **Ground Tatsuya physically in every space before or while things happen in it, but establish it once.** Set the sound/smell/temperature/light/texture when he enters a space or a scene starts, then don't re-describe it every paragraph after that. Only call it out again when something actually changes it (an explosion shifts the light, wind pushes smoke into his face) and it's directly relevant to what he's doing right then. The environment should keep breathing under the dialogue and action without turning into repeated atmospheric filler.
- **Sensory detail serves character and the immediate action, not scenery.** What Tatsuya notices should say something about him (what he's trained to watch for, what he can't afford to ignore, what catches him off guard) and connect to what he's actually doing in that moment, rather than reading as neutral description anyone could think.
- **Stats and abilities get felt in the body, not just reported as numbers.** When his physical capabilities change (a new body, a stat point spent, an ability firing), show what that actually feels like in movement, how his stance, balance, or reach is different, not just a bracketed number update sitting next to unrelated prose.
- **Gear gets a real, tactile detail when it's newly relevant.** What he's wearing or carrying isn't just named once and forgotten, it gets a lived-in physical beat (wear, fit, how it sits on an unfamiliar body) at the moment it actually matters.
...
- **Micro body cues throughout a scene, not just after dialogue.** A specific, small physical tell (weight shift, hand placement, breath) belongs after a dialogue or monologue beat, per the existing rule, but physical adjustment and positioning should also be present continuously during action generally, not just bookending speech. Tie it back to Tatsuya's established physical/behavioral signature (see `codex/characters/tatsuya-kazehaya.md`) wherever it's genuinely his.
...
4. **Combat: physical positioning and a sensory reaction per beat.** One action per beat, no compressed multi-action paragraphs. Each beat carries where his body actually is (stance, distance, angle to the threat) and what he senses reacting to it, not just the action itself in isolation.
5. **UI and menu mechanics are discovered through trial and error, not known in advance.** This extends to menus and equip mechanics generally, not just combat abilities: Tatsuya doesn't already know how the interface works. He tests a theory about it, acts on the theory, and only confirms it worked through a visible or physical result (an item actually appearing on his body, a screen actually responding), never an instant, fluent understanding of the UI handed to the reader as fact.

**Also worth carrying whenever he's in an unfamiliar body** (the goblin body now, any future body/form change): his calculating inner monologue keeps running, odds, mechanics, working out how something functions, at the same time he's physically adjusting to how the new body actually moves. The two threads interleave in the same passage rather than one finishing before the other starts.
